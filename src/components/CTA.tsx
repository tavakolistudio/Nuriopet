  ...
  return (
    <section id="satin-al" className="section-py relative overflow-hidden" ref={ref}>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #1B4D3E 0%, #1C2B4A 60%, #0f1e38 100%)' }}
      />

      {/* Decorative orbs */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full opacity-10 pointer-events-none"
        style={{ background: 'radial-gradient(circle, #9dcaaf 0%, transparent 70%)', transform: 'translate(30%, -30%)' }} />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full opacity-10 pointer-events-none"
        style={{ background: 'radial-gradient(circle, #a3b3d6 0%, transparent 70%)', transform: 'translate(-30%, 30%)' }} />
      ...
      <div className="container-xl relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Product lifestyle image strip */}
          <motion.div
            className="mb-14 rounded-2xl overflow-hidden shadow-2xl max-w-sm mx-auto"
        ...
        <div className="text-center">
          ...
          >
            <p className="text-xs font-semibold tracking-[0.25em] uppercase text-white/50 mb-6">
              Nurio Pet
            </p>
            <h2
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl font-bold text-base
                         ...
                         hover:bg-brand-green-50 active:bg-brand-green-100
                         transition-all duration-200 shadow-lg hover:shadow-xl w-full sm:w-auto"
            >
          ...
          <motion.p
            className="mt-10 text-xs text-white/30 max-w-lg mx-auto leading-relaxed"
            initial={{ opacity: 0 }}
